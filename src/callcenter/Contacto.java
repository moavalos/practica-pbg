...
public class Contacto {
	...
	public String esEmailValido(String eMail) {
		Integer arroba = 0;
		boolean punto = false;
		String email = "";
		...
		if (arroba == 1 && punto == true && email.equals(eMail))
			return email;
		return email;
	}
	 ...
	 * volver a llamar). 
	 * b. Si el contacto no desea ser llamado nuevamente (la llamada pudo no haber sido exitosa, pero se haga un nuevo intento en el
	 * futuro). 
	 * Observaciones: Texto libre donde el operador deja registro de lo
	 * conversado.
	 */
