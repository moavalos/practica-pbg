...
import seguros.Auto;
import seguros.CompaniaDeSeguro;
import seguros.Persona;
import seguros.PolizaAccidentesPersonales;
import seguros.PolizaCombinadoFamiliar;
import seguros.PolizaDeAuto;
import seguros.PolizaInexistente;
import seguros.SegurosDeVida;
import seguros.SegurosGenerales;
import seguros.TipoDeBeneficiario;
import seguros.Vivienda;
...
public class testing {
	...
	public void queSePuedaEmitirUnaPolizaDeCombinadoFamiliar() {
		...
		Integer cantBeneficiario = 3;

		assertEquals(cantBeneficiario, poliza.obtenerCantidadDeBeneficiario());
		assertEquals(asegurado, poliza.getAsegurado());
		assertEquals(PREMIO, poliza.getPremio());
	}
